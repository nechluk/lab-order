...
* group[=].element[=].target.display = ""
* group[=].element[=].target.equivalence = #relatedto					
* group[=].element[=].target.comment = "Composition.section:order.entry.ofType(CZ_LabInformationAboutOrder).insurance.ofType(CZ_Coverage)"
...
* group[=].element[=].display = "A.1.5 - Author (by whom the Lab Order was/were authored)"
...
* group[=].target = "https://hl7.cz/fhir/lab-order/StructureDefinition/cz-bundleLabOrder"
...
* group[+].source = "https://hl7.cz/fhir/lab-order/StructureDefinition/HeaderLabOrder"
