...
* urgentInformation 0..1 BackboneElement "A.2.7.7 - Urgent information" """Urgent information block in the same structure as other document types (discharge report, patient summary)"""
...
* additionalData 0..1 BackboneElement "A.2.7.8 - Additional formalised data" """"""
