...
* requestedPerformer 0..1 RequestedPerformerCz "A.1.6 - Requested performer" """Requested performer (laboratory)."""
* additionalRecipient 0..* AdditionalRecipientCz "A.1.7 - Additional recipient" """Additional recipient of produced laboratory report"""
