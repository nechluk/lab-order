...
* examination.clinicalEvent 0..1 ClinicalEvent "A.2.8.1.7 - Clinical event (encounter)" """Information about the clinical event to which the ordered examination relates"""
